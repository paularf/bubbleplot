...
print_r($id_class_compound_counts);
...
$st_class_compound_relab = make_st_bound_compound_relab($id_station_name, $id_class_compound_relab);

//print_r($st_class_compound_relab);
...
/*
echo '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="500" width="7000">';
