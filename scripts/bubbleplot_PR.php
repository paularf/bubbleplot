...
$ecs = ["4.1.1.39", "2.3.1.169", "4.2.1.120", "1.2.1.75","1.3.1.84", "5.4.1.3", "4.2.1.153", "6.2.1.18", "2.3.3.8"];

//**3HP/4HB

//$ecs = ["6.3.4.14", "2.1.3.15", "4.2.1.17", "5.3.3.3", "6.4.1.2", "1.2.1.75", "1.1.1.298","6.2.1.36", "4.2.1.116", "1.3.1.84", "6.4.1.3", "5.1.99.1", "5.4.99.2", "1.2.1.76", "6.2.1.40", "4.2.1.120", "4.2.1.150", "1.1.1.35", "2.3.1.9"];
...
//$mg_files = glob("../data/3HP_4HB/grouped/Mg*taxa");
//$end_name = ".test.final_1.taxa";
...
//$mg_site_ec_tax_relab = make_site_ec_tax_relab_arr($mg_files, $end_name, /*$cogs*/$ecs, $mg_count_arr, /*$ec_size_arr,*/ 0.000000);
...
//print_r($z);
$y = get_most_abundant_tax_names_per_ec ($z, $ranking = 4);
//print_r($y);
...
$leyend_scale = [ 1.5e-11, 3.0e-9, 3.0e-8, 1e-7, 1.5e-7];
$scientific_notation = [];
...
$total_counts_ec = add_total_count_per_ec ($mg_files, $end_name, $ecs);
//print_r($total_counts_ec);
$total_counts_ec_tax = add_total_coun_per_ec_tax($mg_files, $end_name, $ecs);
$percentaje = percentaje_of_most_abundant_tax_per_ec($total_counts_ec, $total_counts_ec_tax, $ranking = 5);
$total_percentaje_per_ec = total_percentaje_per_ec($percentaje);
print_r($total_percentaje_per_ec);
...
//$mt_site_ec_tax_relab = make_site_ec_tax_relab_arr($mt_files, $end_name, $ecs, $mt_count_arr, 0.00000);
$mt_site_ec_tax_relab_a = make_site_ec_rel_ab_with_ec_size($mt_files, $ecs, $mt_count_arr, $ec_size_arr, $end_name = ".test.test.final_1.taxa", $limit = 0.00000000);
$mt_total_tax_ab_per_ec = add_total_tax_ab_per_site_and_ec($mt_site_ec_tax_relab_a);
//print_r($z);
$mt_most_abundant_tax_name_per_ec = get_most_abundant_tax_names_per_ec ($mt_total_tax_ab_per_ec, $ranking = 2);
$mt_site_ec_tax_relab = make_most_abundant_site_ec_tax_rel_ab($mt_site_ec_tax_relab_a, $mt_most_abundant_tax_name_per_ec);
...
$mt_bubbleplot->site_name_filters = ['Mt_', '_cDNA_454', '_cDNA_IluMs', '_cDNA_IluMS', '_454', 'IT', 'PA5', 'PA2', 'L001'];
$mt_bubbleplot->delta_x = 15;
$mt_bubbleplot->delta_y = 12;
$mt_bubbleplot->bubble_scale = 150000000;
