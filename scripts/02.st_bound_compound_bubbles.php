...
$id_bound_compound_counts = make_id_bound_compound_counts($file,  $filter = [7]); 
...
$id_bound_compound_relab = order_arr_by_compound($id_class_compound_counts); //cambiar este parámetro a relab o counts dependiendo de lo que queramos, puede ir: $id_bound_compound_counts, $id_bound_compound_relab, $id_class_compound_counts
...
$st_depth_bound_relab_bubbleplot->bubble_scale = 0.02;
