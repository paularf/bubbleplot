...
$mg_site_ec_count_arr = make_site_ec_coun_arr($mg_files, "_ec_counts.txt", $methane_ecs, 5);
...
$mg_bubble_plot->bubble_scale = 100000;
...
$mg_bubble_plot_2->bubble_scale = 100000;
